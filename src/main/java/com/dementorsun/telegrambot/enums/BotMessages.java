...
public enum BotMessages {
    ...
    WELCOME_BACK_WITH_SILENCE_MODE_MESSAGE("%s, хто це в нас тут повернувся. Нагадаю, що перед тим як мене видалити я був переведений у режим мовчання. Щоб повернути нашу дружбу потрібно натиснути на кнопку 'Змінити час' і встановити нове значення. Нехай щастить!"),
    ...
    TOPICS_WITH_SILENCE_MODE_MESSAGE("Навіщо це тобі? Я все одно нічого не відправлю. Кнопка 'Змінити час' тобі у поміч."),

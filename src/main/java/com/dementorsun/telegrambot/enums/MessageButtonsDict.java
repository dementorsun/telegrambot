...
public enum MessageButtonsDict {
    ...
    SCENERY_BUTTON("\uD83D\uDDBC Пейзаж дня", "\uD83D\uDDBC Пейзаж дня ✅", "SCENERY_TOPIC", "SCENERY_TOPIC_MARKED", TopicsDict.SCENERY_TOPIC),
    ANIMALS_BUTTON("\uD83E\uDD81 Дикий звір дня", "\uD83E\uDD81 Дикий звір дня ✅", "ANIMALS_TOPIC", "ANIMALS_TOPIC_MARKED", TopicsDict.ANIMALS_TOPIC),
    FLOWERS_BUTTON("\uD83C\uDF3C Квіти дня", "\uD83C\uDF3C Квіти дня ✅", "FLOWERS_TOPIC", "FLOWERS_TOPIC_MARKED", TopicsDict.FLOWERS_TOPIC),

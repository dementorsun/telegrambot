...
/**
 * Implementation of {@link TopicButton} interface for handling {@link TopicsDict} NASA button.
 */
@Component
@RequiredArgsConstructor
public class NasaTopicButton implements TopicButton {

    private final UserDataHandler userDataHandler;
    private final TopicButtonHandler topicButtonHandler;

    /**
     * Method which return {@link EditMessageReplyMarkup} object to handle {@link TopicsDict} NASA topic button click.
     * @param userId provides user id for getting topics data from Aerospike.
     * @param isMarked provides identifier about mark state of NASA button.
     * @param update provides general data about topics message.
     * @return {@link EditMessageReplyMarkup} object to send it to TelegramBot API for handling NASA button click.
     */
    @Override
